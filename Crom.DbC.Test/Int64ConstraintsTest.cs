...
namespace Crom.DbC.Test
{
	...
	public class Int64ConstraintsTest
	{
		[TestCase(5)]
		[TestCase(10)]
		public void When_equality_expected_with_or_and_equal_expect_no_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(0)]
		[TestCase(1)]
		public void When_ge_expected_and_fulfilled_expect_no_exception(long constraint)
		{
			var obj = new
			{
				Property = 1L
		...
		[TestCase(1)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_ge_not_expected_and_not_fulfilled_expect_exception(long constraint)
		{
			var obj = new
			{
				Property = 1L
		...
		[TestCase(1)]
		[TestCase(2)]
		public void When_le_expected_and_fulfilled_expect_no_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_le_not_expected_and_not_fulfilled_expect_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_lt_expected_and_not_fulfilled_expect_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[TestCase(3)]
		public void When_lt_not_expected_and_fulfilled_expect_no_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[TestCase(3)]
		public void When_between_expected_and_fulfilled_expect_no_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(4)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_between_expected_and_not_fulfilled_expect_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(3)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_between_not_expected_and_not_fulfilled_expect_exception(long value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(0)]
		[TestCase(4)]
		public void When_between_not_expected_and_fulfilled_expect_no_exception(long value)
		{
			var obj = new
			{
				Property = value

// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DecimalConstraintsTest.cs" company="Borderline Studios">
//   Copyright © Borderline Studios. All rights reserved.
// </copyright>
// <summary>
//   Defines the DecimalConstraintsTest type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
{
	[TestFixture]
	public class DecimalConstraintsTest
	{
		[TestCase(5)]
		[TestCase(10)]
		public void When_equality_expected_with_or_and_equal_expect_no_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(0)]
		[TestCase(1)]
		public void When_ge_expected_and_fulfilled_expect_no_exception(decimal constraint)
		{
			var obj = new
			{
				Property = 1m
		...
		[TestCase(1)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_ge_not_expected_and_not_fulfilled_expect_exception(decimal constraint)
		{
			var obj = new
			{
				Property = 1m
		...
		[TestCase(1)]
		[TestCase(2)]
		public void When_le_expected_and_fulfilled_expect_no_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_le_not_expected_and_not_fulfilled_expect_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_lt_expected_and_not_fulfilled_expect_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[TestCase(3)]
		public void When_lt_not_expected_and_fulfilled_expect_no_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(2)]
		[TestCase(3)]
		public void When_between_expected_and_fulfilled_expect_no_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(4)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_between_expected_and_not_fulfilled_expect_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(3)]
		[ExpectedException(typeof(PreConditionException))]
		public void When_between_not_expected_and_not_fulfilled_expect_exception(decimal value)
		{
			var obj = new
			{
				Property = value
		...
		[TestCase(0)]
		[TestCase(4)]
		public void When_between_not_expected_and_fulfilled_expect_no_exception(decimal value)
		{
			var obj = new
			{
				Property = value
